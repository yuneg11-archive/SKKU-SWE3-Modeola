...
public class ArtikTestActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_artik_test);
                    ...
                    new ApiCallback<NormalizedMessagesEnvelope>() {
                        ...
                        public void onSuccess(NormalizedMessagesEnvelope result, int i, Map<String, List<String>> stringListMap) {
                            ...
                            if (!result.getData().isEmpty()) {
                                ...
                                data = result.getData().get(0).getTs().toString();
                            }
    ...
    private void postMsg() {
        ...
        msg.setSdid(ArtikConfig.DEVICE_ID);
    ...
    private void processFailure(final String context, ApiException exc) {
        ...
        exc.printStackTrace();
        showErrorOnUIThread(context+errorDetail, ArtikTestActivity.this);
    }
}